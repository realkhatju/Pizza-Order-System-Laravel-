                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('product#create') }}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="control-label mb-1">Image</label>
                            ...
                            <div class="form-group">
                                <label for="control-label mb-1">Waiting Time</label>
                                <input type="number" name="pizzaWaitingTime" class="form-control @error('pizzaWaitingTime') is-invalid @enderror">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="pizzaPrice" class="form-control @error('pizzaPrice') is-invalid @enderror" placeholder="Price..."></input>
                                @error('pizzaPrice')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
