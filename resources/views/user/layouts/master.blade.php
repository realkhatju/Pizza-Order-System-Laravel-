...
<body class="animsition">
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="#" title="Still Developing" class="nav-item nav-link">My Cart</a>
                            <a href="#" title="Still Developing" class="nav-item nav-link">Contact</a>
                        </div>
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li class="my-3">
                                        <button class="dropdown-item" type="button"><i class="fa-solid fa-user"></i>
                                            <a class="text-decoration-none text-black"
                                                href="{{ route('user#accountChangePage') }}">
                                                Account
                                            </a>
                                        </button>
                                    </li>
                                    <li class="my-3">
                                        <button class="dropdown-item text-decoration-none" type="button"><i
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            ...
            <div class="col-md-6 px-xl-0 text-center text-md-right">
                <img class="img-fluid" src="{{ asset('admin/lib/img/payments.png') }}" alt="">
            </div>
        </div>
    </div>
    <!-- Footer End -->
    ...
    <!-- Template Javascript -->
    <script src="{{ asset('admin/js/customermain.js') }}"></script>
</body>
    @yield('scriptSource')
</html>
